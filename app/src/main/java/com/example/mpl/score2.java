...
public class score2 extends AppCompatActivity {
    ...
    private DocumentReference documentReference = fStore.collection("tournament").document(idx).collection("innings2").document("batsman");
    private DocumentReference documentReference1 = fStore.collection("tournament").document(idx).collection("innings2").document("bowler");
